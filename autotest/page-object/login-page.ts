...
export class LoginPage extends CommonPage {
    ...
    navigateTo() {
        browser.driver.get(browser.baseUrl)
            .then(() => {
                browser.wait(ExpectedConditions.visibilityOf(this.SIGNIN_BTN), Constant.DEFAULT_TIME_OUT)
            })
            .then(() => {
    ...
    verifyLoggedUserNameDisplayed() {
        return browser.wait(ExpectedConditions.visibilityOf(this.LOGGED_USER_NAME), Constant.DEFAULT_TIME_OUT)
            .then(() => {
