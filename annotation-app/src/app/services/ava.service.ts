...
export class AvaService {
  ...
  public generate(id?: any, format?: string, src?: string, onlyLabelled?: string): Observable<any> {
    return this.http.get<any>(`${this.baseUrl}/projects/generate?pid=${id}&format=${format}&src=${src}&onlyLabelled=${onlyLabelled}`);
  }
  ...
  public getSample(dataSetId?: any): Observable<any> {
    return this.http.get<any>(`${this.baseUrl}/projects/tickets/examples?pid=${dataSetId}`).map(res => {
      let flag = []
  ...
  public getALLSrs(payload: any): Observable<any> {
    return this.http.get(`${this.baseUrl}/projects/tickets?pid=${payload.id}&page=${payload.pageNumber}&limit=${payload.limit}`);
  }
  ...
  public getAllFlag(projectName?: any, pageNumber?: number, limit?: number): Observable<any> {
    return this.http.get<any>(`${this.baseUrl}/projects/tickets/users/flags?pname=${projectName}&page=${pageNumber}&limit=${limit}`);
  };


  public getAllFlagTickets(projectName?: any, pageNumber?: number, limit?: number): Observable<any> {
    return this.http.get<any>(`${this.baseUrl}/projects/tickets/flags?pname=${projectName}&page=${pageNumber}&limit=${limit}`);
  };
